...
public class TestDataProvider 
{
	...
	private String getData(String testCaseName, String keyName,String sheetName)
	{
	...
	public String getUsername(String testCaseName,String sheet)
	{
		return getData(testCaseName, "Username",sheet);
	}
	
	public String getPassword(String testCaseName,String sheet)
	{
		return getData(testCaseName, "Password",sheet);
	}
	
	// This method takes a testCaseName and a columnName, then find and return the value in the cell
	public String getTestData(String testCaseName, String columnName,String sheetName)
	{
		return getData(testCaseName, columnName,sheetName);
	}
